        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-stone-800 text-white p-6 rounded-lg shadow-md max-w-md">
                ...
                <div className="flex justify-around">
                    <button
                        className="bg-white text-black hover:opacity-80 font-bold px-4 py-2 rounded"
                        onClick={onLogout}
                    >
                        Logout
                    </button>
                    <button
                        className="bg-stone-400 hover:opacity-80 text-black font-bold px-4 py-2 rounded"
                        onClick={onCancel}
                    >
                        Cancel
                    </button>
