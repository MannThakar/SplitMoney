...
const UpdatePaying = () => {
    ...
    const handleMemberClick = (memberId, memberName) => {
        ...
        navigate(`/group/${id}/expense/${expenseId}/expensedetails/editexpense`, { state: { user_id: memberId, selectedMemberName: memberName } });
    ...
    return (
        <div className="bg-primaryColor h-svh">
            <div className='py-3 px-2 flex justify-between'>
                <button className='flex gap-2' onClick={() => navigate(`/group/${id}/expense/${expenseId}/expensedetails/editexpense`)}>
