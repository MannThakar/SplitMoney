...
//                             </div>
//                             <h2 className='text-white font-nunito text-base flex justify-center'>INR <span className=' pl-2 text-base text-white font-nunito font-extrabold'>₹{item.amount}</span></h2>
//                             <div className='mt-4'>
